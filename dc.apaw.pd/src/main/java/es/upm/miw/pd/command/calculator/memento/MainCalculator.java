...
public class MainCalculator {
    ...
    public MainCalculator() {
        ...
        MementableCalculator mementableCalculator=new MementableCalculator(calculator);
        ...
        this.commandManager.add(new SaveCommand(mementableCalculator));
        this.commandManager.add(new RestoreCommand(mementableCalculator));
    }
